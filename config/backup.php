...
return [
    ...
    'notifications' => [
        'notifications' => [
            // Notifications are disabled in v1: every notification class is present
            // with an empty channel array, so nothing is sent. The nightly backup is
            // monitored via `backup:list` / `backup:monitor` and the operator runbook.
            // Enable by adding channels, e.g. [BackupHasFailedNotification::class => ['mail']].
