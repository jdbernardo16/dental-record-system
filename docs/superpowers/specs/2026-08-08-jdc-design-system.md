...
| Welcome page hero                  | `jdc-square.png` | 200×auto   | Centered above heading                              |
| Auth pages (login/register/forgot) | `jdc-square.png` | 160×auto   | Above form card                                     |
...
- `resources/js/Pages/Welcome.vue` — Swap BrandMark for jdc-square.png
- `resources/js/Layouts/GuestLayout.vue` — Update gradient + logo
- `resources/js/Pages/Auth/Login.vue` — Swap BrandMark for jdc-square.png
- `resources/js/Pages/Auth/Register.vue` — Swap BrandMark for jdc-square.png
- `resources/js/Pages/Auth/ForgotPassword.vue` — Swap BrandMark for jdc-square.png
...
2. Update Welcome.vue with jdc-square.png
3. Update GuestLayout.vue gradient
4. Update all Auth pages with jdc-square.png
...
- JDC Rectangle Logo: `public/images/jdc-square.png`
